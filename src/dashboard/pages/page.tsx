...
import MyPlugin from '../plugins/myplugin/plugin';
            ...
            columns={[
              ...
              },
              {
                ...
                render: (row: products.Product) => {
                  ...
                  const discountedPrice = row.priceData?.discountedPrice;
                  const priceWidth = 90;

                  if (price != null && discountedPrice && discountedPrice < price) {
                    return (
                      <Box
                        direction="horizontal"
                        align="center"
                        style={{ minWidth: priceWidth, width: priceWidth, justifyContent: 'flex-start' }}
                      >
                        <Text size="small" weight="normal" style={{ marginRight: 8 }}>
                          ${discountedPrice}
                        </Text>
                        <span
                          style={{
